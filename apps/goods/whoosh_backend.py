...
from apps.goods.tokenizer import ChineseAnalyer
import json
import os
import re
import shutil
    ...
    def build_schema(self, fields):
        ...
        for field_name, field_class in fields.items():
            if field_class.is_multivalued:
                ...
                schema_fields[field_class.index_fieldname] = TEXT(stored=True, analyzer=ChineseAnalyer(), field_boost=field_class.boost, sortable=True)
